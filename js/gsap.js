...
.fromTo("#red-bubble", { fill: "red", opacity: 1 }, { repeat: -1, duration: 2, scale: "1.1", ease: "elastic", opacity: 1 })
    ...
    .fromTo("#blue-bubble", { opacity: 0, y: 0 }, { duration: 2, opacity: 1, x: 2, y: -2, repeat: -1 }, 2)
    .fromTo("#small-blue-bubble", { opacity: 0, y: 0 }, { duration: 1, opacity: 1, y: -2, repeat: -1 }, 2)
    .fromTo("#blue-ring", { opacity: 0, y: 0 }, { duration: 4, opacity: 1, y: -2, repeat: -1 }, 2)